...
public class AssetUploadRequest {
    ...
    @Schema(description = "Asset title", example = "Company Logo", requiredMode = Schema.RequiredMode.REQUIRED)
    ...
    @Schema(description = "Asset type", example = "IMAGE", requiredMode = Schema.RequiredMode.REQUIRED)
